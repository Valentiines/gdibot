...
var botConfigs = {
    token: "NjQyNzQxMDkzMjUwNzYwNzQ1.Xcb8oQ.Nyc94DF92eqpsD0kYxrgEke78zo",
    prefix: "!gdi ",
...
client.on("message", async function (message) {
    ...
    if (command === "ticket" && botConfigs.plugins[12].activated == true) {
        ...
        if (message.channel.id === botConfigs.ticketsystem.createTicketChannelID) {
            ...
            if (subject.length > 120) return message.channel.send("Subject max length: 120 characters").catch(console.error);
